/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../api/wrangler.json` (hash: c577b0ad82d185a80dc6fa1577ae11cb)
...
declare namespace Cloudflare {
	interface Env {
		...
		API: Service<typeof import("../api/src/main").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<
				Cloudflare.Env,
				"VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_SIGN_IN_URL"
			>
		> {}
}
